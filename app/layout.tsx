...
export const metadata: Metadata = {
  title: 'Comunidad Yafer — Habitaciones en Alquiler | Cochabamba, Bolivia',
  description:
    'Habitaciones en alquiler en Calle Victorino Vega N° 108, Cochabamba. Cerca del Hospital Universitario, Univalle y Mercado Campesino. Agua, luz e internet incluidos.',
  openGraph: {
    title: 'Comunidad Yafer — Habitaciones en Alquiler | Cochabamba',
    description: 'Encuentra tu habitación ideal en Cochabamba. Todo incluido.',
    type: 'website',
  },
}
        ...
        <PublicOnly>
          ...
          <footer className="bg-gradient-to-r from-violet-900 to-indigo-900 text-white py-10 mt-16">
            <div className="max-w-6xl mx-auto px-4 text-center">
              ...
              <p className="text-violet-300 text-sm">Calle Victorino Vega N° 108 — Zona Mercado Campesino, Cochabamba</p>
