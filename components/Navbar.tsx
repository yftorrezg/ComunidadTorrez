...
import { Home, BookOpen, MapPin, Settings } from 'lucide-react'
    ...
    <header className="sticky top-0 z-30 bg-white/90 backdrop-blur-md border-b border-violet-100 shadow-sm shadow-violet-100/50">
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-1 flex-wrap justify-end">
          ...
          <Link
            href="/admin"
            className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm text-gray-400 hover:text-violet-600 hover:bg-violet-50 transition-all font-medium"
          >
            <Settings size={15} />
